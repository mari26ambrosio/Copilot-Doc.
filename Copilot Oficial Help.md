...
A seguir estão os três tipos de suporte oferecidos:

 - Técnico [inserir link para o tópico em questão]
...
1.  Realizar login na conta [inserir link para o tópico em questão]
...
![enter image description here](https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExMDBpaGNtM204ZnpjaXEzM2E1cXBxMzlhbHZvZm1zYzFvbnVlcHpjdiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/kjYsoVpoQn6I2Xn5AD/giphy.gif)
...
1.  Clique no botão "Faça uma pergunta"
2.  Selecione o idioma desejado para o atendimento 
...
-   **Explique o objetivo:** Descreva o que você pretende alcançar ou solucionar, fornecendo detalhes importantes, como o contexto da situação, as etapas realizadas e o resultado esperado.
-   **Detalhe o problema:** Identifique o que não está funcionando corretamente, incluindo mensagens de erro, comportamentos inesperados ou dificuldades específicas.
...
1. **Título**: Assunto da sua solicitação
2.  **Descrição**: Descreva de forma detalhada o cenário que está enfrentando, incluindo o contexto geral, as etapas realizadas até o momento, os resultados obtidos e o comportamento esperado. 
3.  **Nível de experiência com a plataforma**: Escolha a opção que melhor descreve o seu nível de experiência na plataforma VTEX:
    -   _Estou familiarizado com os recursos básicos. Estou aprendendo._
    -   _Conheço tudo o que preciso para fazer meu trabalho bem._
    -   _Sou experiente e entendo recursos avançados._
4. **Agência**: Informe qual agência é responsável pelo gerenciamento do seu site, caso tenha uma.
5.  **Usuários impactados pelo problema**: selecione a opção que melhor descreve quais usuários estão sendo afetados:
    -   _Usuários do painel administrativo_
    -   _Compradores, consumidores ou usuários finais_
    -   _Todos os usuários_
6.  **Impacto do problema**: selecione a opção que melhor descreve o impacto do problema:
...
7.  **Ambiente onde o problema está ocorrendo**: selecione a opção do ambiente que corresponde ao problema:
    -   _Produção_
    - _Desenvolvimento / QA / Sandbox_
8. **Tipo de problema**: selecione o tipo de problema que necessita ajuda:
